...
function Edit(_ref) {
  ...
  const handleHeadingChange = (name, id) => {
    ...
    const index = _.findIndex(carList, {
      id: id
    });
  ...
  const handleDescriptionChange = (name, id) => {
    const carList = [...attributes.data]; // console.log(carList)
    ...
    length = carList.length + 1; // console.log(length)
  ...
  const removeLast = () => {
    attributes.data.pop(); // console.log(attributes)
  ...
  return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, // attributes.data.push(sample);
...
function save(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, attributes.data.map(d => {
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, d.heading), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, d.description))];
  }));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"custom/accordion","version":"1.0.0","title":"Accordion","category":"widgets","icon":"flag","description":"Add Accordion for block","attributes":{"message":{"type":"string","source":"text","selector":"div"}},"supports":{"html":false},"textdomain":"accordion","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
